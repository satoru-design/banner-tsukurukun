        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-start mb-14">
          ...
          <div className="md:col-span-2">
            ...
            <div className="mt-6 space-y-4 text-sm sm:text-base text-slate-700 leading-[1.95]">
              <p>
                楽天で EC コンサル、RIZAP で月 9 千万円の広告運用、フリークアウトで DSP/SNS 広告、クリーマでアプリマーケ。ネクイノでマーケ部部長として GMV を 0 から 3 億円へ。
              </p>
              <p>
                どこの現場でも、勝ちバナーが見つかってから、それを 17 サイズに展開する作業に、毎月数百時間が消えていました。デザイナーへの依頼書、修正のやり取り、納期。本当はもっと、戦略と検証に時間を使いたかった。
              </p>
              <p>
                「勝ちバナー作る君」は、自分たちのチームが日々の運用で使うために作りました。
                <span className="font-bold text-slate-900">累計 100 社以上のマーケティング支援・3 億円超の広告運用</span>
                を通じて見えた「これさえあれば」を、ひとつのツールに詰めています。
              </p>
            </div>
          </div>
        </div>
