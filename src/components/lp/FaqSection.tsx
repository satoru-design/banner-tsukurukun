...
const FAQS = [
  ...
  {
    q: 'Pro の月 100 本を超えたらどうなりますか?',
    a: '101 本目以降は超過課金として、翌月の請求に自動加算されます。生成は止まらず継続できます（料金詳細はプランページをご参照ください）。',
  },
  {
    q: 'Free プランで 11 本目を生成するとどうなりますか?',
    a: '生成は可能ですが画像に「PREVIEW」透かしが入ります。本番利用には Starter 以上をご検討ください。',
  },
  {
    q: '無料体験で作ったバナーは、解約・退会後も残りますか?',
    a: 'ご自身でダウンロードした画像はお手元に残ります。アカウント上の履歴は退会と同時に削除されますが、退会前であれば ZIP 一括ダウンロードでバックアップが可能です。',
  },
  {
    q: '入力した商品情報・LP URL は安全に扱われますか?',
    a: '生成プロンプト構築のために利用しますが、画像生成 API には商品画像そのものは送信しません（抽象タグのみ）。アップロード素材は暗号化保管、第三者提供は行いません。',
  },
  {
    q: '勝ちバナー学習はどう動きますか?',
