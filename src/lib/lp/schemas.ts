...
export const LpBriefSchema = z.object({
  ...
  customerPain: z.string().max(2000).optional(),
  riskReversal: z.string().max(1000).optional(),
  referenceLpUrls: z.string().max(2000).optional(),
  proofMetrics: z.string().max(1500).optional(),
